    ...
    return (
        <div className='container' style={{ marginTop: '100px', marginBottom: '100px', border: '1px solid #d0cdcd', boxShadow: "2px 2px 3px 2px #d0cdcd", borderRadius: '10px' }}>
            ...
            <div style={{ textAlign: 'center' }}>
                <img id='blogImg' src="https://newapps.anchoredge.in/branding/Content/Blogimage/thumb/791whether_to_go_for_mutual_fund_or_PMS.png" alt="blog_image" />
            </div>
            <div className='container' style={{ fontSize: '18px', padding: '25px' }}>
                ...
                <strong style={{ marginTop: '15px' }}>Portfolio Management Services</strong>
                <p style={{ fontSize: "12pt", marginTop: '15px' }}>
                ...
                <strong style={{ marginTop: '15px' }}>Comparing Mutual Funds and PMS</strong>
                <p style={{ fontSize: "12pt", marginTop: '15px' }}>
