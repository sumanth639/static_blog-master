  ...
  return (
    <div className='container' style={{ marginTop: '100px', marginBottom: '100px', border: '1px solid #d0cdcd', boxShadow: "2px 2px 3px 2px #d0cdcd", borderRadius: '10px' }}>
      ...
      <div style={{ textAlign: 'center' }}>
        <img id='blogImg' src="https://newapps.anchoredge.in/branding/Content/Blogimage/thumb/1718453275Powerofcompounding2-01.png" alt="blog_image" />
      </div>
      <div className='container' style={{ fontSize: '18px', padding: '25px' }}>
      <strong>The Power of Compounding: How SIPs Can Turbocharge Your Mutual Fund Returns</strong>
        ...
        <strong style={{ marginTop: '15px' }}>Understanding Compounding</strong>
        <p style={{ fontSize: "12pt", marginTop: '15px' }}>
          Compounding is often called the "eighth wonder of the world" in investment. An asset can generate earnings, which are then reinvested to generate their earnings. This cycle continues, allowing your wealth to grow exponentially over time. The longer you remain invested, the greater the impact of compounding.
        </p>
        <p style={{ fontSize: "12pt", marginTop: '15px' }}>
        ...
        <p style={{ fontSize: "10pt", marginTop: '5px', fontStyle: 'italic' }}>
          (* For illustration purposes only. The rate of return has been assumed to be 10% CAGR)
        </p>

        <strong style={{ marginTop: '15px' }}>The Power of Systematic Investment Plans</strong>
        <p style={{ fontSize: "12pt", marginTop: '15px' }}>
        ...
        <ul style={{ marginLeft: '20px', marginTop: '15px', fontSize: "12pt" }}>
          <li><strong>Consistent Investing:</strong> SIPs encourage consistent investing, regardless of market fluctuations. This disciplined approach ensures that you stay invested through market cycles, allowing your investments to benefit from the long-term growth potential of equity markets.</li>
          <li><strong>Compounding Effect:</strong> Each SIP installment contributes to the compounding process, as the returns generated are reinvested, and the cycle continues. The longer you maintain your SIP, the more powerful the compounding effect becomes.</li>
          <li><strong>Flexibility:</strong> SIPs offer flexibility in terms of investment amount and frequency, allowing you to tailor your investments to your financial goals and cash flow requirements.</li>
        </ul>

        <strong style={{ marginTop: '15px' }}>The Compounding Advantage</strong>
        <p style={{ fontSize: "12pt", marginTop: '15px' }}>
        ...
        <p style={{ fontSize: "12pt", marginTop: '15px' }}>
          While the example above is hypothetical, it highlights the remarkable potential of compounding when combined with the discipline of SIPs and adding step-up every year. By starting early and staying invested for the long term, you can harness the power of compounding to create substantial wealth and achieve your financial goals.
        </p>
        <p style={{ fontSize: "12pt", marginTop: '15px' }}>
        ...
        <p style={{ fontSize: "12pt", marginTop: '15px', fontStyle: 'italic', color: '#a00' }}>
