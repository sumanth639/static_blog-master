    ...
    return (
        <>
            <div className='container' style={{ marginTop: '100px', marginBottom: '100px', border: '1px solid #d0cdcd', boxShadow: "2px 2px 3px 2px #d0cdcd", borderRadius: '10px' }}>
                <h3 style={{ color: 'white', textAlign: 'center', marginTop: '25px', backgroundColor: '#337ab7', paddingTop: '15px', paddingBottom: '15px', borderRadius: '10px' }}>How to Build a Diversified Portfolio with Mutual Funds</h3>
                <div style={{ textAlign: 'center' }}>
                    <img id='blogImg' src="https://newapps.anchoredge.in/branding/Content/Blogimage/thumb/1697194923divesifiedportfolio-01.png" alt="blog_image" />
                </div>
                <div className='container' style={{ fontSize: '18px', padding: '25px' }}>
                    <strong>Unlocking Wealth: Mastering the Art of Building a Well-Balanced Portfolio through Mutual Funds</strong>
                    <br />
                    ...
                    <strong style={{ marginTop: '15px' }}>Understanding Mutual Funds</strong>
                    <p style={{ fontSize: "12pt", marginTop: '15px' }}>
                    ...
                    <strong style={{ marginTop: '15px' }}>Determine Your Investment Goals and Risk Tolerance</strong>
                    <p style={{ fontSize: "12pt", marginTop: '15px' }}>
                    ...
                    <strong style={{ marginTop: '15px' }}>Diversify for Stability</strong>
                    <p style={{ fontSize: "12pt", marginTop: '15px' }}>
