...
const PortPage21 = () => {
  return (
    ...
    <h3 style={{ color: 'white', textAlign: 'center', marginTop: '25px', backgroundColor: '#337ab7', paddingTop: '15px', paddingBottom: '15px', borderRadius: '10px' }}>Power of Compounding</h3>
    <div style={{ textAlign: 'center' }}>
        <img id='blogImg' src="https://newapps.anchoredge.in/branding/Content/Blogimage/thumb/1689744500WhatsAppImage2023-07-18at11.05.14.jpg" alt="blog_image" />
    </div>
    <div className='container' style={{ fontSize: '18px', padding: '25px' }}>
        ...
        <strong style={{ marginTop: '15px' }}>The concept of compounding</strong>
        <p style={{ fontSize: "12pt", marginTop: '15px' }}>
        ...
        <strong style={{ marginTop: '15px' }}>Starting early: A wise approach</strong>
        <p style={{ fontSize: "12pt", marginTop: '15px' }}>Leveraging time</p>
        <p style={{ fontSize: "12pt", marginTop: '15px' }}>
        ...
        <p style={{ fontSize: "12pt", marginTop: '15px' }}>Building a strong financial foundation</p>
        <p style={{ fontSize: "12pt", marginTop: '15px' }}>
        ...
        <p style={{ fontSize: "12pt", marginTop: '15px' }}>Harnessing the potential of returns</p>
        <p style={{ fontSize: "12pt", marginTop: '15px' }}>
        ...
        <strong style={{ marginTop: '15px' }}>Opportunity loss: The consequence of delaying investment</strong>
        <p style={{ fontSize: "12pt", marginTop: '15px' }}>Missed growth opportunities</p>
        <p style={{ fontSize: "12pt", marginTop: '15px' }}>
        ...
        <p style={{ fontSize: "12pt", marginTop: '15px' }}>Difficulty in catching up</p>
        <p style={{ fontSize: "12pt", marginTop: '15px' }}>
        ...
        <p style={{ fontSize: "12pt", marginTop: '15px' }}>Impact on long-term wealth accumulation</p>
        <p style={{ fontSize: "12pt", marginTop: '15px' }}>
