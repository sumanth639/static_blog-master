  ...
  return (
   <>
       <div className='container' style={{ marginTop: '100px', marginBottom: '100px', border: '1px solid #d0cdcd', boxShadow: "2px 2px 3px 2px #d0cdcd", borderRadius: '10px' }}>
                <h3 style={{ color: 'white', textAlign: 'center', marginTop: '25px', backgroundColor: '#337ab7', paddingTop: '15px', paddingBottom: '15px', borderRadius: '10px' }}>Mind over Money</h3>
                <div style={{ textAlign: 'center' }}>
                    <img id='blogImg' src="https://newapps.anchoredge.in/branding/Content/Blogimage/thumb/1693633854Untitled-1-01.png" alt="blog_image" />
                </div>
        ...
        <strong style={{ marginTop: '15px' }}>The Power of Positive Thinking</strong>
        <p style={{ fontSize: "12pt", marginTop: '15px' }}>
        ...
        <strong style={{ marginTop: '15px' }}>Overcoming Limiting Beliefs</strong>
        <p style={{ fontSize: "12pt", marginTop: '15px' }}>
        ...
        <strong style={{ marginTop: '15px' }}>Managing Emotions</strong>
        <p style={{ fontSize: "12pt", marginTop: '15px' }}>
        ...
        <strong style={{ marginTop: '15px' }}>Setting Clear Goals</strong>
        <p style={{ fontSize: "12pt", marginTop: '15px' }}>
