    ...
    return (
        <>
            <div className='container' style={{ marginTop: '100px', marginBottom: '100px', border: '1px solid #d0cdcd', boxShadow: "2px 2px 3px 2px #d0cdcd", borderRadius: '10px' }}>
                <h3 style={{ color: 'white', textAlign: 'center', marginTop: '25px', backgroundColor: '#337ab7', paddingTop: '15px', paddingBottom: '15px', borderRadius: '10px' }}>Unpacking the Benefits of Balance Advantage Funds for Investors</h3>
                <div style={{ textAlign: 'center' }}>
                    <img id='blogImg' src="https://newapps.anchoredge.in/branding/Content/Blogimage/thumb/169823105425.10.2023BalancedAdvantageFund-01.jpg" alt="blog_image" />
                </div>
                <div className='container' style={{ fontSize: '18px', padding: '25px' }}>
                    <strong>Unpacking the Benefits of Balance Advantage Funds for Investors</strong>
                    <br />
                    ...
                    <strong style={{ marginTop: '15px' }}>What are Balance Advantage Funds?</strong>
                    <p style={{ fontSize: "12pt", marginTop: '15px' }}>
                    ...
                    <strong style={{ marginTop: '15px' }}>The Benefits of Balance Advantage Funds</strong>
                    <p style={{ fontSize: "12pt", marginTop: '15px' }}>
                        <strong>1. Risk Mitigation</strong><br />
                    ...
                    <p style={{ fontSize: "12pt", marginTop: '15px' }}>
                        <strong>2. Capital Appreciation</strong><br />
